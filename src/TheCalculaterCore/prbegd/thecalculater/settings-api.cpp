...
namespace {namespace impl::load_config_tempalte {
    ...
    template <typename T>
    void createItemPropertyNumber(std::unique_ptr<ItemProperty>& propertyPtr, const Json::Value& item, const std::string& itemName, std::optional<std::string>& name, std::optional<std::string>& description, std::optional<std::string>& note, std::optional<std::string>& warning, std::optional<std::string>& deprecated)
    {
    ...
    void createItemPropertyString(std::unique_ptr<ItemProperty>& propertyPtr, const Json::Value& item, const std::string& itemName, std::optional<std::string>& name, std::optional<std::string>& description, std::optional<std::string>& note, std::optional<std::string>& warning, std::optional<std::string>& deprecated)
    {
    ...
    void createItemPropertyList(std::unique_ptr<ItemProperty>& propertyPtr, const Json::Value& item, const std::string& itemName, std::optional<std::string>& name, std::optional<std::string>& description, std::optional<std::string>& note, std::optional<std::string>& warning, std::optional<std::string>& deprecated)
    {
    ...
    void createItemPropertyObject(std::unique_ptr<ItemProperty>& propertyPtr, const Json::Value& item, const std::string& itemName, std::optional<std::string>& name, std::optional<std::string>& description, std::optional<std::string>& note, std::optional<std::string>& warning, std::optional<std::string>& deprecated)
    {
    ...
    void createItemPropertyEnum(std::unique_ptr<ItemProperty>& propertyPtr, const Json::Value& item, const std::string& itemName, std::optional<std::string>& name, std::optional<std::string>& description, std::optional<std::string>& note, std::optional<std::string>& warning, std::optional<std::string>& deprecated)
    {
    ...
    void createItemProperty(std::unique_ptr<ItemProperty>& propertyPtr, const Json::Value& item, const std::string& itemName, ValueType type, std::optional<std::string>& name, std::optional<std::string>& description, std::optional<std::string>& note, std::optional<std::string>& warning, std::optional<std::string>& deprecated)
    {
        switch (type) {
        case ValueType::Integer:
