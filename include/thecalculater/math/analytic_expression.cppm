...
namespace thecalculater::math {
    ...
    public:
        ...
        [[nodiscard]] virtual util::unique_pmr_ptr<INode> clone(util::observer_ptr<std::pmr::memory_resource> memoryResource) const = 0;
        [[nodiscard]] util::unique_pmr_ptr<INode> clone() const;
        [[nodiscard]] util::unique_pmr_ptr<INode> clone(util::unique_pmr_ptr<INode>) const;
    ...
    public:
        ...
        [[nodiscard]] util::unique_pmr_ptr<INode> clone(util::observer_ptr<std::pmr::memory_resource> memoryResource) const override;
    ...
    struct AnalyticExpression::SimplifyContext {
        ...
        std::bitset<_ActionCount> actions;
